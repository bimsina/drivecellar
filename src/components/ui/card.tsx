...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card bg-card text-card-foreground ring-foreground/5 dark:ring-foreground/10 flex flex-col gap-6 overflow-hidden rounded-[calc(var(--radius)+4px)] py-6 text-sm shadow-md ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-[calc(var(--radius)+4px)] *:[img:last-child]:rounded-b-[calc(var(--radius)+4px)]',
        className,
      )}
      {...props}
    />
